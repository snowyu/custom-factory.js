...
class Codec {
  constructor() {
    // console.log('??TCL:: ~ file: base-factory-ability.spec.js:9 ~ Codec ~ constructor:', arguments, this.initialize.toString());
    this.initialize.apply(this, arguments)
  }
  initialize(aOptions) {
    // console.log('TCL:: ~ file: base-factory-ability.spec.js:12 ~ Codec ~ initialize ~ aOptions:', aOptions);
...
describe('BaseFactory Ability', () => {
  addBaseFactoryAbility(Codec)
  it('should addBaseFactoryAbility', () => {
  ...
  describe('BaseFactory', () => {
    ...
    expect(isInheritedFrom(MyNewCodec, Codec))
    aliases(MyNewCodec, 'new', 'new2')
    expect(MyNewCodec).toHaveProperty('Factory', Codec)
    ...
    describe('static members', () => {
      describe('helper functions', () => {
        ...
        it('should respect _isFactory when using ability', () => {
          ...
          addBaseFactoryAbility(AbilityFactory)
          class G {}
        ...
        it('should prioritize registered item class _isFactory over ability factory _isFactory', () => {
          ...
          addBaseFactoryAbility(LeafFactory)
          class E {
